...
from lerobot_policy_recap.reinforcement_loop.learning_modules.data_collectors.feature_patch.utils import (
...
class InteractionDatasetRecorder:
    ...
    def _init_dataset(self) -> LeRobotDataset:
        ...
        print(colored(f"Dataset features: {dataset_features}", "yellow"))
